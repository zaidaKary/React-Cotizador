...
const Formulario = ({guardarResumen, guardarCargando}) => {
    ...
    const cotizarSeguro = e => {
        ...
        // Americano incremento de 15% de lo que llevemos no de la base
        // Asiático incremento de 5% de lo que llevemos no de la base
        // Europeo incremento de 30% de lo que llevemos no de la base
